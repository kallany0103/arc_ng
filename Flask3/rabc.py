...
#from flask_security import RoleMixin, roles_required
...
def register():
    ...
    role_name = data['role']  # Get the desired role name from the registration data
...
def get_current_user():
    ...
    return jsonify({'message': 'successfully got current user'}), 200
...
# Delete author route with role protection
